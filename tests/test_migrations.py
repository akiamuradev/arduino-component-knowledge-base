...
def test_audit_filter_indexes_migration_renders_reversible_downgrade(
    monkeypatch: MonkeyPatch,
    capsys: pytest.CaptureFixture[str],
) -> None:
    monkeypatch.setenv(
...
def test_correction_proposal_migration_renders_reversible_downgrade(
    monkeypatch: MonkeyPatch,
    capsys: pytest.CaptureFixture[str],
) -> None:
    monkeypatch.setenv(
