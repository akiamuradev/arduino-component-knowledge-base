...
authentication/RBAC, frontend-каркас, безопасные image/video pipelines и durable
Redis/Dramatiq jobs с administrator monitor.
Предметные таблицы каталога и parsers ещё не реализованы. Editorial UI
