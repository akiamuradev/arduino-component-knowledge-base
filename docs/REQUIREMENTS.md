...
REQ-UI-003. Технические идентификаторы могут отображаться только в административной
диагностике и проверяемых исходных данных. Обычный пользователь не видит `failed`,
`successful`, `retry`, `draft`, `revision`, названия очередей и обработчиков.
