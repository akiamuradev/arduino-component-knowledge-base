...
`20260721_16`. Целевая версия: `1.0.0`, Alembic `20260729_28`.
...
- in-place downgrade новой схемой с `20260729_28` до `20260721_16` до появления записей
  формата 1.0.0;
...
| Применение миграций | точный tagged head `20260721_16` обновлён до единственного head `20260729_28` | пройдено |
