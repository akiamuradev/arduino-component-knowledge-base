  ...
  return (
    <article className="source-card">
      ...
      <dl className="source-facts">
        ...
        <div><dt>Версия обработчика</dt><dd>{source.adapter_version}</dd></div>
...
export function SourcesPage() {
  ...
  if (sources.isError) return <ErrorState message="Сервер не вернул реестр источников." onRetry={() => { void sources.refetch(); }} />;
