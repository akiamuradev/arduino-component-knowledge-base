  ...
  return (
    <article className="about-page">
      ...
      <section className="about-sources" id="material-sources">
        ...
        <p>Материалы могут ссылаться на Seeed Studio Wiki и официальные библиотеки KiCad, но сейчас все зарегистрированные источники неактивны и недоступны для запуска нового импорта. Исторические записи сохранены в реестре для прозрачности; владелец AlexGyver отдельно запретил использование материалов.</p>
