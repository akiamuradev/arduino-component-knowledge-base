...
class Settings(DatabaseSettings):
    ...
    media_upload_rate_limit: int = Field(default=20, ge=1, le=200)
    media_upload_rate_window_seconds: int = Field(default=60, ge=10, le=3600)
    ...
    job_dispatch_batch_size: int = Field(default=100, ge=1, le=1000)
    job_dispatch_interval_seconds: int = Field(default=5, ge=1, le=60)
    job_dispatch_claim_lease_seconds: int = Field(default=60, ge=10, le=300)
    job_dispatch_stale_seconds: int = Field(default=60, ge=30, le=3600)
    import_lock_ttl_seconds: int = Field(default=60, ge=10, le=300)
    import_lock_wait_seconds: int = Field(default=10, ge=1, le=30)
    import_pending_job_limit: int = Field(default=5, ge=1, le=50)
    import_global_pending_job_limit: int = Field(default=100, ge=10, le=1000)
    import_submission_rate_limit: int = Field(default=10, ge=1, le=200)
    import_submission_rate_window_seconds: int = Field(default=60, ge=10, le=3600)
